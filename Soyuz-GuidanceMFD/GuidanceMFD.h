/////////////////////////////////////////////////////////////////////////////////
//
//	GuidanceMFD.h - Header file for the Soyuz Guidance & Control MFD 
//  (SoyuzGuidanceMFD.dll)
//
...
// CCK How often should update calculatons be done?  For now, this needs to stay at 0.25 due to 
// a bug
const double CALC_INTERVAL = 0.5;	
...
VECTOR3 KAxis;
double ISP_VAC = 564*9.81; // ISP of main engine in a vacuum m/s (for Soyuz 7K-OK)
