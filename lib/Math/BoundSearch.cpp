...
Result<double> BoundSearch::FindUpper(BinSearchOptiSubject & subj, double start, double minIncrement, double maxIncrement)
{
    return Find(subj, start, true, minIncrement, maxIncrement);
}
Result<double> BoundSearch::FindLower(BinSearchOptiSubject & subj, double start, double minIncrement, double maxIncrement)
{
    return Find(subj, start, false, minIncrement, maxIncrement);
}

Result<double> BoundSearch::Find(BinSearchOptiSubject & subj, double start, bool upper, double minIncrement, double maxIncrement)
{
