...
void StoreVesselParameters()
{
	...
	if (!exists(config_file))	CIniFile::Create(config_file.native_file_string());

	string SectionName(g_Param.parent_vessel->GetClassName());

	// write stage independent parameters
	CIniFile::SetValue("NoStagingDetection", lexical_cast<std::string>(g_Param.no_staging), SectionName, config_file.native_file_string());
	...
	CIniFile::SetValue("ThrustEffectEnabled", lexical_cast<std::string>(g_Param.th_enabled), SectionName, config_file.native_file_string());
	CIniFile::SetValue("ThrustFrequency1", lexical_cast<std::string>(g_Param.fa_thrust[0]), SectionName, config_file.native_file_string());
	CIniFile::SetValue("ThrustAmplitude1", lexical_cast<std::string>(g_Param.fa_thrust[1]), SectionName, config_file.native_file_string()); 
	CIniFile::SetValue("ThrustFrequency2", lexical_cast<std::string>(g_Param.fa_thrust[2]), SectionName, config_file.native_file_string());
	CIniFile::SetValue("ThrustAmplitude2", lexical_cast<std::string>(g_Param.fa_thrust[3]), SectionName, config_file.native_file_string()); 

	// store atmospheric effect settings
	CIniFile::SetValue("AtmosEffectEnabled", lexical_cast<std::string>(g_Param.at_enabled), SectionName, config_file.native_file_string());
	CIniFile::SetValue("AtmosFrequency1", lexical_cast<std::string>(g_Param.fa_atmos[0]), SectionName, config_file.native_file_string());
	CIniFile::SetValue("AtmosAmplitude1", lexical_cast<std::string>(g_Param.fa_atmos[1]), SectionName, config_file.native_file_string()); 
	CIniFile::SetValue("AtmosFrequency2", lexical_cast<std::string>(g_Param.fa_atmos[2]), SectionName, config_file.native_file_string());
	CIniFile::SetValue("AtmosAmplitude2", lexical_cast<std::string>(g_Param.fa_atmos[3]), SectionName, config_file.native_file_string()); 

	// store ground effect settings
	CIniFile::SetValue("GroundEffectEnabled", lexical_cast<std::string>(g_Param.gd_enabled), SectionName, config_file.native_file_string());
	CIniFile::SetValue("GroundFrequency1", lexical_cast<std::string>(g_Param.fa_ground[0]), SectionName, config_file.native_file_string());
	CIniFile::SetValue("GroundAmplitude1", lexical_cast<std::string>(g_Param.fa_ground[1]), SectionName, config_file.native_file_string()); 
	CIniFile::SetValue("GroundFrequency2", lexical_cast<std::string>(g_Param.fa_ground[2]), SectionName, config_file.native_file_string());
	CIniFile::SetValue("GroundAmplitude2", lexical_cast<std::string>(g_Param.fa_ground[3]), SectionName, config_file.native_file_string()); 
	CIniFile::SetValue("GroundMaxSpeed", lexical_cast<std::string>(g_Param.gd_max_speed), SectionName, config_file.native_file_string()); 
}
...
void ReadVesselParameters()
{
	...
	g_Param.no_staging = lexical_cast<BOOL>(CIniFile::GetValueDef("NoStagingDetection", SectionName, config_file.native_file_string(), "0"));
	...
	g_Param.th_enabled = lexical_cast<BOOL>(CIniFile::GetValueDef("ThrustEffectEnabled", SectionName, config_file.native_file_string(), "0"));
	g_Param.fa_thrust[0] = lexical_cast<double>(CIniFile::GetValueDef("ThrustFrequency1", SectionName, config_file.native_file_string(), "50"));
	g_Param.fa_thrust[1] = lexical_cast<double>(CIniFile::GetValueDef("ThrustAmplitude1", SectionName, config_file.native_file_string(), "0.001"));
	g_Param.fa_thrust[2] = lexical_cast<double>(CIniFile::GetValueDef("ThrustFrequency2", SectionName, config_file.native_file_string(), "10"));
	g_Param.fa_thrust[3] = lexical_cast<double>(CIniFile::GetValueDef("ThrustAmplitude2", SectionName, config_file.native_file_string(), "0.004"));

	// read atmospheric effect settings
	g_Param.at_enabled = lexical_cast<BOOL>(CIniFile::GetValueDef("AtmosEffectEnabled", SectionName, config_file.native_file_string(), "0"));
	g_Param.fa_atmos[0] = lexical_cast<double>(CIniFile::GetValueDef("AtmosFrequency1", SectionName, config_file.native_file_string(), "100"));
	g_Param.fa_atmos[1] = lexical_cast<double>(CIniFile::GetValueDef("AtmosAmplitude1", SectionName, config_file.native_file_string(), "0.001"));
	g_Param.fa_atmos[2] = lexical_cast<double>(CIniFile::GetValueDef("AtmosFrequency2", SectionName, config_file.native_file_string(), "50"));
	g_Param.fa_atmos[3] = lexical_cast<double>(CIniFile::GetValueDef("AtmosAmplitude2", SectionName, config_file.native_file_string(), "0.003"));

	// read ground effect settings
	g_Param.gd_enabled = lexical_cast<BOOL>(CIniFile::GetValueDef("GroundEffectEnabled", SectionName, config_file.native_file_string(), "0"));
	g_Param.fa_ground[0] = lexical_cast<double>(CIniFile::GetValueDef("GroundFrequency1", SectionName, config_file.native_file_string(), "100"));
	g_Param.fa_ground[1] = lexical_cast<double>(CIniFile::GetValueDef("GroundAmplitude1", SectionName, config_file.native_file_string(), "0.001"));
	g_Param.fa_ground[2] = lexical_cast<double>(CIniFile::GetValueDef("GroundFrequency2", SectionName, config_file.native_file_string(), "50"));
	g_Param.fa_ground[3] = lexical_cast<double>(CIniFile::GetValueDef("GroundAmplitude2", SectionName, config_file.native_file_string(), "0.003"));
	g_Param.gd_max_speed = lexical_cast<double>(CIniFile::GetValueDef("GroundMaxSpeed", SectionName, config_file.native_file_string(), "100"));
}
...
{	
	...
	if (g_Param.hDlg && (SendDlgItemMessage(g_Param.hDlg, IDC_BTN_TEST_TH, BM_GETSTATE, 0, 0) & BST_PUSHED))
	{
		...
		g_Param.ShakePos.x = g_Param.ShakePos.x + perlin.CreateNoise(SimT, fa_test, 2);
		g_Param.ShakePos.y = g_Param.ShakePos.y + perlin.CreateNoise(1000 + SimT, fa_test, 2);
		g_Param.ShakePos.z = g_Param.ShakePos.z + perlin.CreateNoise(2000 + SimT, fa_test, 2);
	...
	g_Param.ShakePos = g_Param.StartPos;
	g_Param.ShakePos.x = g_Param.ShakePos.x + lvl_thrust * perlin.CreateNoise(SimT, g_Param.fa_thrust, 2);
	g_Param.ShakePos.y = g_Param.ShakePos.y + lvl_thrust * perlin.CreateNoise(1000 + SimT, g_Param.fa_thrust, 2);
	g_Param.ShakePos.z = g_Param.ShakePos.z + lvl_thrust * perlin.CreateNoise(2000 + SimT, g_Param.fa_thrust, 2);
	g_Param.ShakePos.x = g_Param.ShakePos.x + lvl_atmos * perlin.CreateNoise(3000 + SimT, g_Param.fa_atmos, 2);
	g_Param.ShakePos.y = g_Param.ShakePos.y + lvl_atmos * perlin.CreateNoise(4000 + SimT, g_Param.fa_atmos, 2);
	g_Param.ShakePos.z = g_Param.ShakePos.z + lvl_atmos * perlin.CreateNoise(5000 + SimT, g_Param.fa_atmos, 2);
	g_Param.ShakePos.x = g_Param.ShakePos.x + lvl_ground * perlin.CreateNoise(6000 + lvl_ground * SimT, g_Param.fa_ground, 2);
	g_Param.ShakePos.y = g_Param.ShakePos.y + lvl_ground * perlin.CreateNoise(7000 + lvl_ground * SimT, g_Param.fa_ground, 2);
	g_Param.ShakePos.z = g_Param.ShakePos.z + lvl_ground * perlin.CreateNoise(8000 + lvl_ground * SimT, g_Param.fa_ground, 2);
	g_Param.focus_vessel->SetCameraOffset(g_Param.ShakePos);
