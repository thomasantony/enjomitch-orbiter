...
#define ENTER_ALTITUDE				"Dla PEG. Wprowadz: PeA (dla kolowej) -lub- PeA ApA -lub- a (automatyczna) -lub- t (celu)"
#define TARGET						"Wprowadz: Cel -lub- Inklinacje (wzgl. rownika) -lub- Inkl. LAN q (wzgl. rownika) -lub- Inkl. LAN c (wzgl. ekliptyki)"
...
#define ENTER_ALTITUDE				"For PEG. Enter: PeA (for circular) -or- PeA ApA -or- a (for automatic) -or- t (target's)"
#define TARGET						"Enter: Target -or- Inclination (equ. frame) -or- Incl. LAN q (equ. frame) -or- Incl. LAN c (ecl. frame)"
