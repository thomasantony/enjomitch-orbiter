...
PEGDirectAscent::PEGDirectAscent(const VESSEL * v, const ShipVariables & vars)
: PEG( v )
, m_shipVariables(vars)
{
    Reset();
}

PEGDirectAscent::~PEGDirectAscent()
{
}

void PEGDirectAscent::Reset()
{
    toTarget = false;
}

void PEGDirectAscent::Update(MFDDataLaunchMFD * data)
{
...
void PEGDirectAscent::SetToTarget( bool set )
{
    toTarget = set;
}

bool PEGDirectAscent::IsToTarget() const
{
    return toTarget;
}
