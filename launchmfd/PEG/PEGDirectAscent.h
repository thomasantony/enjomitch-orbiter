...
#ifndef PEGDIRECTASCENT_H
#define PEGDIRECTASCENT_H

#include "peg.h"
class MFDDataLaunchMFD;
class ShipVariables;

class PEGDirectAscent : public PEG
{
    public:
        PEGDirectAscent(const VESSEL * v, const ShipVariables & vars);
        virtual ~PEGDirectAscent();
    ...
    protected:
        virtual void UpdateClient( MFDDataLaunchMFD * data ) = 0;
    private:

        bool toTarget;
};

#endif // PEGDIRECTASCENT_H
