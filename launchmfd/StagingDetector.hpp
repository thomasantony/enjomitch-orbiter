...
#ifndef STAGINGDETECTOR_H
#define STAGINGDETECTOR_H
...
{
    public:
        StagingDetector(const VESSEL * vessel);
        virtual ~StagingDetector();
        bool Update( const VESSEL * v );
    protected:
    private:

    double savedPrecentageMassChange;
    double prevMass;
    double timeNoted;
    bool shouldRecord;
