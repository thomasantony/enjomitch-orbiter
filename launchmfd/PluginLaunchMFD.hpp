...
#ifndef PLUGINLAUNCHMFD_HPP_INCLUDED
#define PLUGINLAUNCHMFD_HPP_INCLUDED

#include <multipleVesselsMFD/PluginMultipleVessels.hpp>
#include "Autopilot/AutopilotManager.hpp"
#include <MFDSound++/Sound.hpp>
#include "Sound/SoundMapLaunchMFD.hpp"
#include "MFDButtonPageLaunchMFD.hpp"
#include <string>

class PluginLaunchMFD : public EnjoLib::MFDGoodies::PluginMultipleVessels
{
public:
    PluginLaunchMFD( HINSTANCE hDLL );
    ~PluginLaunchMFD();
    bool IsFuelLimited();
    EnjoLib::MFDGoodies::Sound & GetSound();
    const MFDButtonPageLaunchMFD & GetButtonPages() const;

    const AutopilotManager m_apMan;
...
private:
    ...
    bool CfgCkeckVariable( const std::string & varName );

    bool m_isFuelLimited;


    EnjoLib::MFDGoodies::Sound m_sound;
    const SoundMapLaunchMFD m_soundMap;
    MFDButtonPageLaunchMFD m_buttonPages;
};

#endif // PLUGINLAUNCHMFD_HPP_INCLUDED
