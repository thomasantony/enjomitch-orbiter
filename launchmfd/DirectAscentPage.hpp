...
#ifndef DIRECTASCENTATMOPAGE_H
#define DIRECTASCENTATMOPAGE_H
...
class DirectAscentPage : public MFDPage
{
public:
...
protected:
    ...
    std::vector< const EnjoLib::ValueWithDescription > PrepareData(MFDDataLaunchMFD * data);

private:
    EnjoLib::MFDGoodies::Sound & m_sound;
};

#endif // DIRECTASCENTATMOPAGE_H
