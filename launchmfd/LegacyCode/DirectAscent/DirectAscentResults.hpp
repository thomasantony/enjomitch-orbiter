...
#ifndef DIRECTASCENTRESULTS_HPP_INCLUDED
#define DIRECTASCENTRESULTS_HPP_INCLUDED

#include "DirectAscentPhase.hpp"
#include "Times.h"

class DirectAscentResults
{
public:
  DirectAscentResults();
  DirectAscentResults(double currentTime, const Times & times );
  DirectAscentPhase GetCurrentPhase( double currentTime );
  double GetTimeOfPhase( DirectAscentPhase phase, double currentTime );
  double GetTimeOfCurrentPhase( double currentTime );
  bool IsValid();
...
#endif // DIRECTASCENTRESULTS_HPP_INCLUDED
