...
#ifndef OPTIMALVELSOLVERPARAMS_H
#define OPTIMALVELSOLVERPARAMS_H


struct OptimalVelSolverParams
{
  double latStart, angDist, shAsymptoteAzimuth, azimuth, target_radius;
  OptimalVelSolverParams()
  {
    latStart = angDist = shAsymptoteAzimuth = azimuth = target_radius = 0;
  }
};

#endif // OPTIMALVELSOLVERPARAMS_H
