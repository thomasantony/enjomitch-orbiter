...
public:
    ...
    std::vector <EnjoLib::Point> vGCStart; // ship's starting path (great circle)
    std::vector <EnjoLib::Point> s;   // turning path vector - east
    EnjoLib::Vect3 basePlaneN;
    EnjoLib::Point pos2D_prev;
    EnjoLib::Point vel;      // ship's velocity
    EnjoLib::Point prev_vel;
