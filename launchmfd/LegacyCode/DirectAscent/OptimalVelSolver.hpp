...
#ifndef OPTIMALVELSOLVER_HPP_INCLUDED
#define OPTIMALVELSOLVER_HPP_INCLUDED
...
#include "VelIntegral.h"

class CaVertParams;

class OptimalVelSolver
{
  public:
    OptimalVelSolver();
...
#endif // OPTIMALVELSOLVER_HPP_INCLUDED
