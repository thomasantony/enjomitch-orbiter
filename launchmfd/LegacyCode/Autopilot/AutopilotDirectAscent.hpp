...
#ifndef AUTIPILOTDIRECTASCENT_HPP_INCLUDED
#define AUTIPILOTDIRECTASCENT_HPP_INCLUDED

#include "AutopilotBase.hpp"

class AutopilotDirectAscent : public AutopilotBase
{
public:
...
#endif // AUTIPILOTDIRECTASCENT_HPP_INCLUDED
