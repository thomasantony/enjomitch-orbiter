...
//                         All rights reserved
//
// LaunchCompass.h - Calculations of compass for vertical launches
...
public:
    ...
    void SetTargetAzimuth(double azimuth, LAUNCH_AZIMUTH azFlag);
    void SetApses(double PeA, double ApA);
...
private:
    void DrawCompassRose(MyDC hDC);
    void DrawTargetPitchAndLines(MyDC hDC, double targetIncl, double radius);
    void DrawVessel(MyDC hDC);
    void PrintWords(MyDC hDC, bool launched);
