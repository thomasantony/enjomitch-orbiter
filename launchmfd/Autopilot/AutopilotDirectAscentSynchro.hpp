...
#ifndef AUTOPILOTDIRECTASCENTSYNCHRO_H
#define AUTOPILOTDIRECTASCENTSYNCHRO_H

#include "AutopilotBase.hpp"

/// Synchro mode: create an intersection ahead and cruise
class AutopilotDirectAscentSynchro : public AutopilotBase
{
    public:
        AutopilotDirectAscentSynchro();
        virtual ~AutopilotDirectAscentSynchro();
...
#endif // AUTOPILOTDIRECTASCENTSYNCHRO_H
