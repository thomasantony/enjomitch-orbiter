...
DirectAscentOptiEngineLevel::DirectAscentOptiEngineLevel( MFDDataLaunchMFD * data )
: m_data(data)
, m_pegDAOpti( data->GetVessel(), data->GetShipVariables() )
{
}

DirectAscentOptiEngineLevel::~DirectAscentOptiEngineLevel()
{}

double DirectAscentOptiEngineLevel::GetRefValue() const
{
...
bool DirectAscentOptiEngineLevel::IsValid( double arg, double lastValue )
{
    //return m_pegDAOpti.IsValid();
    return true;
}
