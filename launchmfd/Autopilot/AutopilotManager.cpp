...
const AutopilotBase * AutopilotManager::GetAP(AutopilotType type) const
{
    switch (type)
    {
    case AP_STANDARD:
        return &m_APStandard;
    case AP_DIRECT_ASCENT_STD:
        return &m_APDirectAscentStd;
    case AP_DIRECT_ASCENT_SYNCHRO:
        return &m_APDirectAscentSynchro;
    case AP_NONE:
        return NULL;
    }
