...
#ifndef PitchPointComparator_H
#define PitchPointComparator_H
...
class PitchPointComparator
{
    public:
        PitchPointComparator();
        virtual ~PitchPointComparator();

        bool operator()( const EnjoLib::Point & a1, const EnjoLib::Point & a2) const;
    protected:
    private:
};

#endif // PitchPointComparator_H
