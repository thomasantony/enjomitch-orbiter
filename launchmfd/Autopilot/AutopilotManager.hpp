...
{
public:
    const AutopilotBase * GetAP(AutopilotType type) const;

private:
    AutopilotStandard m_APStandard;
    AutopilotDirectAscentStd m_APDirectAscentStd;
    AutopilotDirectAscentSynchro m_APDirectAscentSynchro;
};
