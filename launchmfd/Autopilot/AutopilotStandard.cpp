...
std::string AutopilotStandard::GetIdentifier() const
{
    return AUTOPILOT;
}

bool AutopilotStandard::NeedPitch( MFDDataLaunchMFD * data ) const
{
    return data->drawPitchError;
}
bool AutopilotStandard::NeedYaw( MFDDataLaunchMFD * data ) const
{
    return true;
}
bool AutopilotStandard::NeedPullUp( MFDDataLaunchMFD * data ) const
{
    return false;
}
bool AutopilotStandard::NeedMECO( MFDDataLaunchMFD * data ) const
{
    return true;
}

bool AutopilotStandard::TerminationRequested( MFDDataLaunchMFD * data ) const
{
    return false;
}

bool AutopilotStandard::Guide( MFDDataLaunchMFD * data, double dt ) const
{
    return AutopilotBase::Guide( data, dt );
}
