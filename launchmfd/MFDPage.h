...
//                         All rights reserved
//
// MFDPage.h - class for derriving of MFD modes (pages) - standard, compass and direct ascent
...
public:
	...
	virtual ~MFDPage();
	// Pure virtual function that needs overloading
	virtual
    MFD_RETURN_TYPE Update ( MyDC hDC, MFDDataLaunchMFD * data ) = 0;
...
protected:
	DWORD m_W, m_H;
	VESSEL *vessel;
	bool isHUDDrawing;	// whether or not the class is drawing to the HUD
